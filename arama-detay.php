                        ...
                        <div role="tabpanel" class="tab-pane fade in active clear products-container" id="list-view">
                            <div class="product-list-view">
                                ...
                                if (isset($_POST['searchsayfa'])) {
                                    ...
                                    INNER JOIN kullanici ON urun.kullanici_id=kullanici.kullanici_id WHERE urun_durum=:urun_durum
                                    and urun.urun_ad LIKE '%$searchkeyword%' order by urun_zaman DESC  ");
                                    ...
                                    $say = $sorgu->rowCount();
                                    if ($say == 0) {
                                        echo 'Aramanızla eşleşen sonuç bulunamadı! Lütfen daha detaylı yazın.';
                                    }
                                }
                                        ...
                                        <div class="item-content">
                                            <div class="item-info">
                                                ...
                                                <div class="item-sale-info">
                                                    <div class="price"><?php echo $uruncek['urun_fiyat']  ?> <span style="font-size: 12px;"> <i class="fa fa-try" aria-hidden="true"></i></span>
                                                    </div>
                                            ...
                                            while ($s < $toplam_sayfa) {
                                                ...
                                                if (!empty($_GET['kategori_id'])) {
                                                    if ($s == $sayfa) { ?>
                                                        ...
                                                        <li class="active"><a href="arama-detay-<?php echo $_GET['sef']; ?>-<?php echo $_GET['kategori_id'] ?>?sayfa=<?php echo $s; ?>"><?php echo $s; ?></a></li>


                                                    <?php } else { ?>


                                                        <li><a href="arama-detay-<?php echo $_GET['sef']; ?>-<?php echo $_GET['kategori_id'] ?>?sayfa=<?php echo $s; ?>"><?php echo $s; ?></a></li>
                                                    ...
                                                    if ($s == $sayfa) { ?>
                                                        ...
                                                        <li><a style="background-color: #C84C3C; color:white;" href="arama-detay?sayfa=<?php echo $s; ?>"><?php echo $s; ?></a></li>

                                                    <?php } else { ?>

                                                        <li><a href="arama-detay?sayfa=<?php echo $s; ?>"><?php echo $s; ?></a></li>
