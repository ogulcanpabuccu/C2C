...
<head>
    ...
    <!-- Dropzone.js toplu resim eklemeye yarar-->
    ...
    <!-- CK Editör yazım editörü  uzak server
                    ...
                    <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
                        <div class="menu_section">
                            ...
                            <ul class="nav side-menu">
                                ...
                                <li><a href="yorumlar.php"><i class="fa fa-comment-o"></i> Yorumlar </a></li>
