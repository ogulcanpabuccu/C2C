    ...
    <div class="">
        ...
        <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    <div class="x_title">
                        <h2>Mağaza Onayı bekleyenler <small>
                            ...
                            <tbody>
                                ...
                                while ($kullanicicek = $kullanicisor->fetch(PDO::FETCH_ASSOC)) { ?>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <center> <a href="magaza-onay-islemleri.php?kullanici_id=<?php echo $kullanicicek['kullanici_id']; ?>"><button class="btn btn-primary btn-xs">Mağaza İnceleme</button></a></center>
                                        </td>
