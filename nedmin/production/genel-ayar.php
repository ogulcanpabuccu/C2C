                ...
                <div class="x_panel">
                    <div class="x_title">
                        <h2>Genel Ayarlar <small>
                                ...
                                <?php } elseif ($_GET['durum'] == "uzantihatali") { ?>

                                    <b style="color: red;">Hatalı uzantı girdiniz.Lütfen jpg veya png formatında dosyalar yükleyin.</b>

                                <?php } elseif ($_GET['durum'] == "dosyabuyuk") { ?>

                                    <b style="color: red;">Dosya boyutu çok büyük 2 megabyte altında bir dosya yükleyin.</b>
                    ...
                    <div class="x_content">
                        <br />
                        <!-- Resim yükleme alanı başlangıcı  -->
